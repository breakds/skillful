...
**Single context (most repos):** One `TERMINOLOGY.md` at the repo root.

**Multiple contexts:** A `TERMINOLOGY-MAP.md` at the repo root lists the contexts, where they live, and how they relate to each other:
...
- If `TERMINOLOGY-MAP.md` exists, read it to find contexts
- If only a root `TERMINOLOGY.md` exists, single context
